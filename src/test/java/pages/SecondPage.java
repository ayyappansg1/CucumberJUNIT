...
public class SecondPage extends LocalHelper {
	...
	public void performActionOnSlider() {
		...
		slidingUsingMouseAction(slider, sliderText);
	}

	public boolean verifySliderText(Integer number) {
		logger.info("Verifying slider text");
		return getTextContent(sliderText).equals(Integer.toString(number));
	}
	...
	public boolean mouseHoverToEachImage(List<Map<String, String>> wholeList) {
		...
		for (int i = 0; i < images.size(); i++) {
			mouseHover(images.get(i));
			list.add(getTextContent(imageText.get(i)));
		}
	...
	public void clickOnJQueryBackUI() {
		clickElement(backToJQueryUI, DriverManager.getDriver());
	}
	public boolean verifyMenuHyperLink() {
		return verifyElement(menuHyperLink);
	}
	public void clickMenuRedirectLink() {
		clickElement(menuHyperLink, DriverManager.getDriver());
	}
	public boolean verifyRedirectionLink(String url) {
		return getCurrentPageUrl(DriverManager.getDriver()).contains(url);
	}
	public void mouseHoverToDownloadsPage() {
		mouseHover(enabledTab);
		mouseHover(downloadsTab);
	}
	public boolean verifyDownloadsTabOptions(String first,String second,String third) {
		...
		List<String> allTextContents = getAllTextContentsPlain(downloadsOptions);
		return allTextContents.containsAll(textFromFeatureFile);
	}

	public void clicksOnPdfOption() {
		clickElement(downloadsOptions.get(0), DriverManager.getDriver());
	}
	public boolean verifyDownloadedFile() {
		return verifyFileName("menu");
	}
	public void clickJSAlertButton() {
		clickElement(clickForJsAlertButton, DriverManager.getDriver());
		handlingAlertWithAllPossibleActions("accept", null);
	}
	
	public void clickJSAlertConfirmButton() {
		clickElement(clickForJsAlertConfirmButton, DriverManager.getDriver());
		handlingAlertWithAllPossibleActions("accept", null);
	}
	public void clickJSAlertConfirmWithCancelButton() {
		clickElement(clickForJsAlertConfirmButton, DriverManager.getDriver());
		handlingAlertWithAllPossibleActions("dismiss", null);
	}
	public void clickJSAlertPromptButton(String text) {
		clickElement(clickForJsAlertPromptButton, DriverManager.getDriver());
		handlingAlertWithAllPossibleActions("accept", text);
	}
	public boolean verifyJSAlertButton(String text) {
		return getTextContent(resultText).equals(text);
	}
	public boolean verifyUserLandingPageAfterClickJSOnloadError() {
		return verifyUrlContainsExpectedText("javascript_error", DriverManager.getDriver());
	}
	public boolean verifyJavascriptErrorOnPage(String text) {
		return getTextContent(jsErrorText).contains(text);
	}
	public void pressKeysBasedOnGiven(List<String> list) {
		logger.info("Before key press");
		pressKeysAndReturnTextFromChangeOccured = pressKeysAndReturnTextFromChangeOccured(list,resultText);
	}
	...
	public void fetchValueFromTable() {
		tableValue = getTextContent(tableCellValue);
	}
	...
	public void clickClickHereNewWindow() {
		...
		clickElement(clickHereToOpenNewWindow, DriverManager.getDriver());
	}
	public boolean switchToNewWindowAndGrabText(String text) {
		switchToAnotherWindow(parentWindow);
		String textContent = getTextContent(newWindowText);
	...
	public boolean fetchingRightFrameTextAndVerify(String right) {
		switchToFrame(DriverManager.getDriver(), topFrame);
		switchToFrame(DriverManager.getDriver(), rightFrame);
		String textContent = getTextContent(rightFrameContent);
	...
	public void clickClickHereNotificationUntilNewMessageAppears() {
		String textContent = getTextContent(flashMessage);
		while(textContent.equals(firstFlash)) {
		clickElement(clickHereNotificationLoad, DriverManager.getDriver());
		textContent = getTextContent(flashMessage);
		}
	}
	...
	public void clickRedirectLink() {
		clickElement(redirectClick, DriverManager.getDriver());
	}
	...
	public boolean gettingTextFromFirstParagraphShadowDom(String text) {
		return getTextFromShadowDomAccessing(shadowHost, "[slot='my-text']").contains(text);
	}
	public boolean gettingTextFromSeconddParagraphShadowDom(String first,String second) {
		...
		List<String> textFromShadowDomAccessingMultiple = getTextFromShadowDomAccessingMultiple(shadowHostSecond, "[slot='my-text'] li");
	...
	public boolean clickMenuElementAndVerifyTabs(List<String> lists) {
		clickElement(menuElement, DriverManager.getDriver());
		List<String> allTextContents = getAllTextContents(tabNames);
		return lists.containsAll(allTextContents);
	}
	public boolean clickHomeElementAndRedirectToHomePage() {
		clickElement(tabNames.get(0), DriverManager.getDriver());
		return getCurrentPageUrl(DriverManager.getDriver()).equals("https://the-internet.herokuapp.com/");
	}
	public void clickAnImageButtonAndGetBeforeClickCssValue() {
		HomePage.getInstance().clickShiftingContentButton();
		clickElement(anImageElement, DriverManager.getDriver());
		...
		clickElement(clickHereToReloadForImage, DriverManager.getDriver());
	}
	...
	public void clickList() {
		directlylandOnParticularUrl("https://the-internet.herokuapp.com/shifting_content");
		clickElement(listElement, DriverManager.getDriver());
	}
	public boolean compareContentsForEveryLoad() {
		String[] textContent = getTextContent(centreContents).split("\n");
		List<String>list=new ArrayList<String>();
		...
		String[] textContentAfterRefresh = getTextContent(centreContents).split("\n");
	...
	public boolean verifyLastNameFirstTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example1LastNames);
		Collections.sort(beforeSorting);
		logger.info("Before sorting Lastname column:"+beforeSorting);
		clickElement(lastNameHeaderExample1, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example1LastNames);
	...
	public boolean verifyFirstNameFirstTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example1FirstNames);
		Collections.sort(beforeSorting);
		logger.info("Before sorting treeset firstname column:"+beforeSorting);
		clickElement(firstNameHeaderExample1, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example1FirstNames);
		logger.info("After sorting fromActual web firstname column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyEmailFirstTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example1Email);
		Collections.sort(beforeSorting);
		logger.info("Before sorting Email column:"+beforeSorting);
		clickElement(emailHeaderExample1, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example1Email);
		logger.info("After sorting fromActual web Email column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyDueFirstTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example1Due);
		...
		clickElement(dueHeaderExample1, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example1Due);
	...
	public boolean verifyWebSiteFirstTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example1WebSite);
		Collections.sort(beforeSorting);
		logger.info("Before sorting website column:"+beforeSorting);
		clickElement(websiteHeaderExample1, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example1WebSite);
		logger.info("After sorting fromActual website column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyLastNameSecondTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example2LastNames);
		Collections.sort(beforeSorting);
		logger.info("Before sorting Lastname column:"+beforeSorting);
		clickElement(lastNameHeaderExample2, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example2LastNames);
		logger.info("After sorting fromActual web Lastname column:"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyFirstNameSecondTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example2FirstNames);
		Collections.sort(beforeSorting);
		logger.info("Before sorting treeset firstname column:"+beforeSorting);
		clickElement(firstNameHeaderExample2, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example2FirstNames);
		logger.info("After sorting fromActual web firstname column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyEmailSecondTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example2Email);
		Collections.sort(beforeSorting);
		logger.info("Before sorting Email column:"+beforeSorting);
		clickElement(emailHeaderExample2, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example2Email);
		logger.info("After sorting fromActual web Email column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean verifyDueSecondTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example2Due);
		List<Float>convertedToInt=new LinkedList<Float>();
		for (String string : beforeSorting) {
			convertedToInt.add(Float.parseFloat(string.replace("$", "")));
		}
		Collections.sort(convertedToInt);
		logger.info("Before sorting Due column:"+beforeSorting);
		clickElement(dueHeaderExample2, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example2Due);
		List<Float>convertedToIntAfterSorting=new LinkedList<Float>();
		for (String string : afterSorting) {
			convertedToIntAfterSorting.add(Float.parseFloat(string.replace("$", "")));
		}
	...
	public boolean verifyWebSiteSecondTable() {
		List<String> beforeSorting = getAllTextContentsPlain(example2WebSite);
		Collections.sort(beforeSorting);
		logger.info("Before sorting website column:"+beforeSorting);
		clickElement(websiteHeaderExample2, DriverManager.getDriver());
		List<String> afterSorting = getAllTextContentsPlain(example2WebSite);
		logger.info("After sorting fromActual website column"+afterSorting);
		return beforeSorting.equals(afterSorting);
	}
	public boolean clickAndValidate200StatusCode(int statusCode) throws URISyntaxException, IOException {
		List<String> useDevToolstoGrabAPINetworks = useDevToolstoGrabAPINetworks();
		clickElement(TwoHundredHyperLink, DriverManager.getDriver());
	...
	public boolean clickAndValidate301StatusCode(int statusCode) throws URISyntaxException, IOException {
		directlylandOnParticularUrl("https://the-internet.herokuapp.com/status_codes");
		List<String> useDevToolstoGrabAPINetworks = useDevToolstoGrabAPINetworks();
		clickElement(ThreeZeroOneHyperLink, DriverManager.getDriver());
	...
	public boolean clickAndValidate404StatusCode(int statusCode) throws URISyntaxException, IOException {
		directlylandOnParticularUrl("https://the-internet.herokuapp.com/status_codes");
		List<String> useDevToolstoGrabAPINetworks = useDevToolstoGrabAPINetworks();
		clickElement(FourZeroFourHyperLink, DriverManager.getDriver());
	...
	public boolean clickAndValidate500StatusCode(int statusCode) throws URISyntaxException, IOException {
		directlylandOnParticularUrl("https://the-internet.herokuapp.com/status_codes");
		List<String> useDevToolstoGrabAPINetworks = useDevToolstoGrabAPINetworks();
		clickElement(FiveZeroZeroHyperLink, DriverManager.getDriver());
