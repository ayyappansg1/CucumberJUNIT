...
//	}
	...
	public static List<String> useDevToolstoGrabAPINetworks() {
	...
	public List<String> getAllTextContents(By elements) {
		List<String> li = new LinkedList<String>();
		WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(waitSeconds));
		wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(elements, 1));
		List<WebElement> findElements = DriverManager.getDriver().findElements(elements);
	...
	public List<String> getAllTextContents(List<WebElement> elements) {
		List<String> li = new LinkedList<String>();
		WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(waitSeconds));
	...
	public List<String> getAllTextContentsPlain(List<WebElement> elements) {
		List<String> li = new LinkedList<String>();
		WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(waitSeconds));
		wait.until(ExpectedConditions.visibilityOfAllElements(elements));
	...
	public String handlingAlertWithGetText() {
	...
	public int refreshThePageWithPreviousElementsCount(List<WebElement> elements) {
	...
	public String selectedOptionFromDropdown(WebElement element, WebDriver driver) {
		...
		return getTextContent(textFromElement);
	}
...
//		js.executeScript("window.scrollTo(0, 0);");
	...
	public String clickRandomElement(List<WebElement> allFiles) {
		WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(waitSeconds));
	...
	public void slidingUsingMouseAction(WebElement element, WebElement element2) {
	...
	public void scrollNumberOfTimes(int num) throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
		for (int i = 0; i < num; i++) {
	...
	public void handlingAlertWithAllPossibleActions(String acceptOrDismiss, String enterText) {
		WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(waitSeconds));
	...
	public List<String> pressKeysAndReturnTextFromChangeOccured(List<String> keysToPress, WebElement element) {
...
//					action.keyUp(mp.get(string2)).build().perform();;
	...
	public String getTextFromShadowDomAccessing(WebElement shadowHosts, String cssValueOfInside) {
		JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
...
//		    String shadowRootText = (String) js.executeScript(script, shadowHost, cssValueOfInside);
		WebElement shadowHost = DriverManager.getDriver().findElements(By.tagName("my-paragraph")).get(0);
...
//        String shadowText = paragraph.getText();
	...
	public List<String> getTextFromShadowDomAccessingMultiple(WebElement shadowRoots, String cssValueOfInside) {
		JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
		WebElement shadowHost = DriverManager.getDriver().findElements(By.tagName("my-paragraph")).get(1);
		Object shadowRoot = js.executeScript("return arguments[0].shadowRoot", shadowHost);
	...
	public void directlylandOnParticularUrl(String url) {
